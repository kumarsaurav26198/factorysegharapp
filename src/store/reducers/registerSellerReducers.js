...
export const registerSellerReducers = (state = initialState, action) => {
    switch (action.type)
    {
        case ActionTypes.SELLER_REQUEST_RESTART:
            // console.warn("SELLER_REQUEST Reducers", ActionTypes.SELLER_REQUEST_RESTART);
            console.log("SELLER_REQUEST_RESTART Reducers action===>", );
            return {
                data: [],
                loading: false,
                error: null,
        ...
        case ActionTypes.SELLER_REQUEST_SUCCESS:
        ...
        case ActionTypes.SELLER_REQUEST_FAILURE:
            // console.warn("SELLER_REQUEST_FAILURE Reducers", ActionTypes.SELLER_REQUEST_FAILURE);
            // console.log("SELLER_REQUEST_FAILURE Reducers action===>", action.error);
            return {
                ...state,
                loading: false,
                error: action.error,
        ...
        case ActionTypes.LOG_OUT_REQUEST:
            ...
            // console.log("SELLER_REQUEST_FAILURE Reducers action===>", action);
