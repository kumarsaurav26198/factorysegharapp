...
const SellerOtpScreen = ({ route, verifyRes, loginRes }) => {
  const { mobile } = route?.params;
  const { verifyReq, sellerRequest } = useActions();
...
export default connect(mapStateToProps)(SellerOtpScreen);
